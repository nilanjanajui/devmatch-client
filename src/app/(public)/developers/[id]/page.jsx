                ...
                <div style={{ position: "relative", display: "flex", gap: 28, alignItems: "flex-start" }}>
                    ...
                    <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.18 }} style={{ flex: 1 }}>
                        ...
                        <div style={{ display: "flex", gap: 10, marginTop: 20 }}>
                            <MessageButton
                                recipientId={dev._id}
                                style={{ padding: "9px 22px", borderRadius: 8, fontSize: 13, fontFamily: "monospace", fontWeight: 500, background: "transparent", border: "1px solid rgba(255,255,255,0.25)", color: "#fff", transition: "all 0.2s" }}
