...
import { Globe, Calendar, MapPin, ArrowUpRight, Briefcase, Code2, Quote } from "lucide-react";
...
// ── Avatar — uses <img> not Next.js Image to handle SVG/any URL reliably ──
...
function ProfileSkeleton() {
    return (
        <div style={{ maxWidth: 980, margin: "0 auto", padding: "40px 24px" }}>
            ...
            <Bone style={{ height: 165, borderRadius: 20, marginBottom: 12 }} />
            <Bone style={{ height: 100, borderRadius: 16, marginBottom: 12 }} />
            <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: 12 }}>
                <div>
                    <Bone style={{ height: 240, borderRadius: 16, marginBottom: 12 }} />
                    <Bone style={{ height: 260, borderRadius: 16 }} />
                </div>
                <div>
                    <Bone style={{ height: 280, borderRadius: 16, marginBottom: 12 }} />
                    <Bone style={{ height: 380, borderRadius: 16 }} />
                </div>
            </div>
        </div>
    );
...
export default function DeveloperProfile() {
    ...
    // ── Support both old schema (authorName/authorRole) and new (author/role)
                ...
                <div style={{ position: "relative", display: "flex", gap: 24, alignItems: "flex-start", flexWrap: "wrap" }}>
                    ...
                    <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.18 }}
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                            <h1 style={{ color: "#fff", fontSize: 30, fontWeight: 700, fontFamily: "monospace", margin: 0 }}>
                                {dev.name}
                            </h1>
                            {dev.isPro && (
                        ...
                        <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
                            <button
                                style={{ padding: "9px 22px", borderRadius: 8, fontSize: 13, fontFamily: "monospace", fontWeight: 600, background: "transparent", border: "1px solid rgba(255,255,255,0.2)", color: "#fff", cursor: "pointer", transition: "all 0.2s" }}
                            ...
                            {dev.portfolio && (
                                <a href={dev.portfolio} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
                                    <button
                                        style={{ padding: "9px 22px", borderRadius: 8, fontSize: 13, fontFamily: "monospace", fontWeight: 600, background: "rgba(0,229,255,0.08)", border: "1px solid rgba(0,229,255,0.3)", color: "#00e5ff", cursor: "pointer", transition: "all 0.2s" }}
            ...
            <motion.div
                ...
                {[
                    ...
                    <div key={label} style={{ ...CARD, textAlign: "center", padding: "16px 10px" }}>
                        <p style={{ color: "rgba(255,255,255,0.32)", fontSize: 10, fontFamily: "monospace", letterSpacing: "0.08em", textTransform: "uppercase", margin: "0 0 8px" }}>
                            {label}
                        </p>
                        <p style={{ color: "#fff", fontSize: 28, fontWeight: 700, fontFamily: "monospace", margin: 0 }}>
                            {value}
                        </p>
                    </div>
                ))}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: 12, alignItems: "start" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    ...
                    <motion.div
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 4, marginTop: 10, color: "rgba(255,255,255,0.25)", fontSize: 11, fontFamily: "monospace" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                        ...
                        <motion.div
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                                {dev.featuredProjects.map((proj, i) => (
                                    <motion.div key={i}
                                        initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.42 + i * 0.07 }}
                                        ...
                                        <div style={{ padding: "14px 14px 16px" }}>
                                            ...
                                            <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
                                                {(proj.tags ?? []).map((tag, ti) => (
                                                    <span key={ti} style={{ color: "rgba(255,255,255,0.45)", fontSize: 10, fontFamily: "monospace", background: "rgba(255,255,255,0.05)", borderRadius: 4, padding: "2px 7px", letterSpacing: "0.04em" }}>
                                                        {tag}
                                                    </span>
                                                ))}
                                            </div>
                    ...
                    {(hasExp || hasTesti) && (
                        <motion.div
                                    ...
                                    <div style={{ position: "relative", paddingLeft: 24, marginBottom: hasTesti ? 28 : 0 }}>
                                        ...
                                        {dev.experience.map((e, i) => (
                                            <motion.div key={i}
                                                ...
                                                <h3 style={{ color: "#fff", fontFamily: "monospace", fontWeight: 700, fontSize: 14, margin: "0 0 4px" }}>
                                                    {e.role}
                                                </h3>
                                                ...
                                                {e.description && (
                                                    <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 12, fontFamily: "monospace", lineHeight: 1.75, margin: 0 }}>
                                                        {e.description}
                                                    </p>
                                                )}
                                            </motion.div>
                            ...
                            {/* Divider between experience and testimonials */}
                            {hasExp && hasTesti && (
                            ...
                            {hasTesti && (
                                <>
                                    {/* Show heading when there's no experience above */}
                                    {!hasExp && <SectionTitle icon={Quote} label="Testimonials" />}

                                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                                        {testimonials.map((t, i) => (
                                            <motion.div key={i}
                                                initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 + i * 0.07 }}
                                                style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12, padding: 18 }}>
                                                <p style={{ color: "rgba(255,255,255,0.55)", fontSize: 11, fontFamily: "monospace", fontStyle: "italic", lineHeight: 1.8, margin: "0 0 16px" }}>
                                                    &ldquo;{t.quote}&rdquo;
                                                </p>
                                                <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
                                                    ...
                                                    <div>
                                                        <p style={{ color: "rgba(255,255,255,0.8)", fontSize: 12, fontFamily: "monospace", fontWeight: 600, margin: 0, lineHeight: 1 }}>
                                                            {t.author || "Anonymous"}
                                                        </p>
                                                        <p style={{ color: "rgba(255,255,255,0.35)", fontSize: 10, fontFamily: "monospace", margin: "4px 0 0", textTransform: "uppercase", letterSpacing: "0.07em" }}>
                                                            {t.role}
                                                        </p>
                                                    </div>
                                                </div>
                    ...
                    {/* Empty state — only when ALL right-column sections are empty */}
